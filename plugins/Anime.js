...
for (const [cmdName, url] of Object.entries(waifuEndpoints)) {
  cmd({
    ...
    await conn.sendMessage(from, { image: { url: data.url }, caption: `🎴 *${cmdName}*` }, { quoted: mek });
  });
}
...
cmd({
  ...
  await conn.sendMessage(from, { text: `💬 "${data.quote}"\n- ${data.character} (${data.anime})` }, { quoted: mek });
});
...
cmd({
  ...
  await conn.sendMessage(from, { image: { url: data.url }, caption: "💌 Waifu Quote" }, { quoted: mek });
});
...
cmd({
  ...
  await conn.sendMessage(from, { text: `🤔 *Anime Fact:* ${fact}` }, { quoted: mek });
});
...
cmd({
  ...
  await conn.sendMessage(from, { text: `❓ *Quiz:* ${selected.q}\n_Answer: ${selected.a}_` }, { quoted: mek });
});
...
cmd({
  ...
  await conn.sendMessage(from, { video: { url: gif }, caption: "🎲 Anime Roll" }, { quoted: mek });
});
...
cmd({
  ...
  await conn.sendMessage(from, { image: { url: selected.url }, caption: "🎮 Guess this character!" }, { quoted: mek });
});
